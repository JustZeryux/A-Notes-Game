/* === GLOBAL CONFIG & VARIABLES (RESTORATION MASTER V115) === */
...
// === DICCIONARIO DE FORMAS (SHARED PATHS) ===
const SKIN_PATHS = {
...
const SHOP_ITEMS = [
    ...
    { id: 'skin_shuriken', name: 'Ninja Star', price: 4000, type: 'skin', desc: 'Shurikens giratorios (Usa tu color).', color: '#FFF', fixed: false, shape: 'shuriken' },
    { id: 'skin_sniper', name: 'Crosshair', price: 3000, type: 'skin', desc: 'Miras tácticas (Usa tu color).', color: '#0F0', fixed: false, shape: 'sniper' },
    { id: 'skin_plasma', name: 'Plasma Orb', price: 5000, type: 'skin', desc: 'Núcleo de energía inestable.', color: '#BD00FF', fixed: true, shape: 'circle' },
    { id: 'ui_cyber', name: 'Marco Cyber', price: 1500, type: 'ui', desc: 'Borde futurista para avatar.', color: '#00FFFF', fixed: true }
];

// === LÓGICA DE CARRILES (KEYBINDINGS) ===
...
// === CONFIGURACIÓN GLOBAL (window.cfg) ===
window.cfg = { 
...
// === ESTADO DEL USUARIO (window.user) ===
window.user = { 
...
// Variables persistentes en RAM
window.ramSongs = [];
window.curIdx = -1;
window.keys = 4;
window.remapMode = null;
window.remapIdx = null;
window.curSongData = null; 
window.songFinished = false;

// Estado Online
window.peer = null; window.conn = null; window.opponentScore = 0; window.isMultiplayer = false;
window.currentLobbyId = null; window.isLobbyHost = false; window.lobbyListener = null;
window.lastSentScore = 0;

// Iconografía (Paths Legacy)
window.PATHS = {
